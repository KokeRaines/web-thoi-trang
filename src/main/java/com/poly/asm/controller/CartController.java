...
public class CartController {
    ...
    public String addToCartFromForm(
            ...
            @RequestParam(value = "buyNow", defaultValue = "false") boolean buyNow, // Thêm param này
            HttpServletRequest request,
            HttpServletResponse response,
            RedirectAttributes redirectAttributes) {
        ...
        // Nếu là "Mua ngay" -> Chuyển sang trang giỏ hàng hoặc checkout
        if (buyNow) {
            return "redirect:/cart"; 
        }
        
        // Nếu chỉ là "Thêm vào giỏ" -> Ở lại trang chi tiết
